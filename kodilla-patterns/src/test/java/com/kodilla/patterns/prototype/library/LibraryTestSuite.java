...
public class LibraryTestSuite {
    ...
    void testGetBooks() {
        ...
        IntStream.iterate(1, n -> n + 1)
                .limit(10)
                .forEach(n -> library.getBooks().add(new Book("Title" + n, "Author" + n, localDate1)));
        ...
        library.getBooks().forEach(n -> System.out.println("  " + n.getTitle() + " " + n.getAuthor() + " " + n.getPublicationDate()));
        System.out.println(clonedLibrary.getName());
        clonedLibrary.getBooks().forEach(n -> System.out.println("  " + n.getTitle() + " " + n.getAuthor() + " " + n.getPublicationDate()));
        System.out.println(clonedLibrary1.getName());
        clonedLibrary1.getBooks().forEach(n -> System.out.println("  " + n.getTitle() + " " + n.getAuthor() + " " + n.getPublicationDate()));
